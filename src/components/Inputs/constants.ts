...
export const FloatingLabelStyle = {
    ...
    disabled: "text-gray-400 bg-transparent peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1"
} as inputState
...
export const FloatingInputStyle = {
    ...
    disabled: "block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-600 bg-gray-50 rounded-lg border-1  border-gray-200 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
} as inputState
