export default {
    ...
    inputicon: {
        class: ['sm:text-sm', 'absolute top-[50%] -mt-2', 'text-mercury-600 dark:text-mercury-200', 'right-[.75rem]']
    },
    dropdownbutton: {
        root: {
            class: [
    ...
    header: ({ props }) => ({
        class: [
            ...
            // Spacing
            'm-0',
            { 'py-2 pb-4': !(props.numberOfMonths > 1), 'py-2 pb-4': props.numberOfMonths > 1 },
    ...
    weekheader: {
        class: ['leading-6 text-sm font-normal', 'text-mercury-600 dark:text-white/70', 'opacity-40 cursor-default', 'mb-2']
    },
    weeknumber: {
        class: ['text-mercury-600 dark:text-white/70 font-normal', 'opacity-40 cursor-default']
    },
    weekday: {
        class: [
            // Colors
    ...
    weeklabelcontainer: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                'text-mercury-600 dark:text-white/70 bg-transparent': !context.selected && !context.disabled,
                'text-selenium-500  dark:text-selenium-400': context.selected && !context.disabled
            },
    ...
    daylabel: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                'text-white bg-mercury-200 dark:text-mercury-900 dark:bg-white': context.date.today && !context.selected && !context.disabled,
                'text-mercury-600 dark:text-white/70 bg-transparent': !context.selected && !context.disabled && !context.date.today,
                'text-white dark:text-selenium-400 bg-selenium-600': context.selected && !context.disabled && !context.date.today,
                'text-white dark:text-selenium-600 bg-selenium-400 dark:bg-white': context.selected && !context.disabled && context.date.today
            },
            ...
            'focus:outline-none focus:outline-offset-0 focus:ring-1 focus:ring-selenium-500 dark:focus:ring-selenium-400',
            {
                ...
                'hover:bg-mercury-700 dark:hover:bg-mercury-200': !context.disabled && context.date.today
            },
